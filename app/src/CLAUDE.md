# app/src — meglévő segédfüggvények

Ez a fájl akkor töltődik be, amikor egy munkamenet `app/src/` alatti fájllal
dolgozik — a gyökér `CLAUDE.md`-ből lett kiemelve, mert a teljes tartalma erre a
könyvtárra szűkül. A helyi konvenció változatlan: **használd ezeket, ne írd újra**.
