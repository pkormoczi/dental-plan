...
export interface ElolegOsszegek {
  eloleg: number;
  /**
   * `null`, ha az előleg meghaladja a fizetendőt (D64) -- ilyenkor a
 ...
 * határ eldől; az `elolegOsszegek` és a véglegesítés-őr is ezt hívja (D64).
 */
 ...
 * összeghez (D64 -- korábban százalékból számolt, drift-mentes érték volt,
