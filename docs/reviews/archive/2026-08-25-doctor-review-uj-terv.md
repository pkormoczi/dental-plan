...
- Döntés: elvetve: már megoldva: a kategórianév-keresés a fb4d776 óta él (ItemPicker kétszintű találati lista, egyezoKategoriaIdk), teszttel fedve (ItemPicker.test.tsx »csak kategórianévre találó tétel megjelenik«, search.test.ts egyezoKategoriaIdk) (2026-09-09)
