...
| Összeg | `tenylegesEgysegar * mennyiseg`, élőben követve: gépelés közben mindkét mező (Ajánlati ár, Db) piszkozatából számol, nem várja meg a mező elhagyását — üres/érvénytelen piszkozatnál a committált értéket mutatja. A fázis-összesen, a sticky „Mindösszesen”, az Előleg és az Egyedi végösszeg ettől függetlenül csak commit után frissül |
