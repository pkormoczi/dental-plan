...
- **Pénznem** (`HUF` / `EUR`) — melyik `Tetel.ar` kulcsot nézi a
  ...
  kiválasztott pénznemben (D69) — egy beárazatlan tétel `—` listaárral,
...
**Pénznemváltás NEM törli a sorokat** (D69): minden sor a másik
...
- A találatok kategória szerint csoportosítva jelennek meg, az ár a sor
  ...
  jelenik meg helyette (D69), a tétel attól még találat és felvehető.
- Csak `aktiv: true` tételek — a pénznem NEM szűr a találatokra (D69):
...
| Listaár | Csak megjelenítés, halványan. Sávos tételnél `35 000–55 000` formában, kiemelve. Egyedi sornál, illetve a terv pénznemében beárazatlan tételnél `—` (nincs árlistai referenciaár, D69) |
...
**Beárazatlan sor (kemény blokk, D69):** ha egy névvel ellátott sor
