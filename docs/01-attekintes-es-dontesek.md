...
| D40 | Az „Új terv indítása" köztes páciensválasztó (D29) kereső mezője kétállású: 0–1 karakternél a D39 recent-listája (max 5, ugyanaz a helper), 2+ karaktertől relevancia szerinti rendezés (teljes név eleje > szótöredék eleje > belső egyezés, azon belül alfabetikus), a tételkeresővel (`ItemPicker.tsx`) azonos gépel → nyíl → Enter/Esc billentyűzet-ciklussal. Nulla találatnál egy közvetlen „Új páciens: „…"" opció a begépelt névvel, a mindig látható „Vadonatúj páciens" gomb mellett | Ez a képernyő minden új tervnél megnyílik, mégis autofókusz és billentyűzet-navigáció nélkül, mindig teljes/alfabetikus listával indult — pont az a ciklus hiányzott róla, amit a CLAUDE.md „A UX kritikus pontja" a tételkeresőnél kötelezővé tesz |
| D41 | Az „Új terv indítása" köztes páciensválasztó (D29/D40) „Vadonatúj páciens" ága (és a kereső nulla találatos „Új páciens: „…"" opciója) a `PaciensekPage.tsx` „+ Új páciens"-ével közös quick-create dialógust nyitja meg — csak sikeres mentés után navigál tovább a Páciens adatlapra. A dialógus születési dátumot/telefont is felvehet (opcionális), és névegyezésnél cselekvő figyelmeztetést ad („Ezt a pácienst választom") | A terv-előtti valódi páciensrekord (D29) korábban csak a `/paciensek` belépési ponton teljesült; a „vadonatúj" ág üres `paciensId`-vel indult, a mappa csak a terv mentésekor materializálódott. Elfogadott mellékhatás: egy elhagyott piszkozat után is ottmarad a létrehozott páciensrekord — ez a Kezdőlap „Legutóbbi páciensek" (D39) listáján is megjelenik |
