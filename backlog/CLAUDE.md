...
`Source: <honnan>` és `Kerdes: <mit kérdezünk a dokitól>`. Tervezett tételnél még
...
marad itt: egy sor a PRODUCT.md Nem cél szakaszába. Dedup: a két mappa slugjai + PRODUCT.md.
→ product:#nem-cel
